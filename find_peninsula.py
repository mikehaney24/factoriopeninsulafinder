...
#
# This is exact for islands but deliberately incomplete for peninsulas: it
# keeps only seeds enclosed in every direction. Measured on 498 seeds with
# ground truth, 1 of the 4 scoring >= 0.50 survived the screen. What it does
# return is heavily enriched for the highly-enclosed tail -- 7.8% of candidates
# score >= 0.50 versus 0.8% of random seeds -- which is the trade this tool
# now makes by default. Use --exhaustive when completeness matters more.
PRESCAN_RAYS = 64
PRESCAN_STEP = 1
